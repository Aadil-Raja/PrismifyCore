...
import pythonLogo from './python1.png'
  ...
  return (
    <section id="tech-stack" className="tech-stack">
      <div className="container">
        <div className="section-containerTechStack">
        ...
        <div className="tech-grid">
          ...
          <div className="tech-card">
            ...
            <h3>Python</h3>
            <p>Versatile language used for scripting, data analysis, and machine learning</p>
          </div>

          <div className="tech-card">
            <div className="tech-icon django-icon">
              <svg viewBox="0 0 24 24" fill="currentColor">
                <path d="M11.146 0h3.924v18.166c-2.013.382-3.491.535-5.096.535-4.791 0-7.288-2.166-7.288-6.32 0-4.001 2.65-6.6 6.753-6.6.637 0 1.121.051 1.707.204zm0 9.143a3.894 3.894 0 0 0-1.325-.204c-1.988 0-3.134 1.223-3.134 3.364 0 2.09 1.096 3.236 3.109 3.236.433 0 .79-.025 1.35-.102V9.143zM21.314 6.06v9.098c0 3.134-.229 4.638-.917 5.937-.637 1.249-1.478 2.039-3.211 2.905l-3.644-1.733c1.733-.815 2.574-1.529 3.109-2.625.561-1.121.739-2.421.739-5.835V6.059h3.924zM17.39.021h3.924v4.026H17.39V.021z" />
              </svg>
            </div>
            <h3>Django</h3>
            <p>High-level Python web framework for rapid development and clean design</p>
          </div>

          <div className="tech-card">
            <div className="tech-icon fastapi-icon">
              <svg viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 0C5.375 0 0 5.375 0 12s5.375 12 12 12 12-5.375 12-12S18.625 0 12 0zm-.624 21.62v-7.528H7.19L13.203 2.38v7.528h4.185L11.376 21.62z" />
              </svg>
            </div>
            <h3>FastAPI</h3>
            <p>High-performance Python web framework for APIs with async support</p>
          </div>
          ...
          <div className="tech-card">
            ...
            <h3>Docker</h3>
            <p>Container platform that simplifies deployment and scalability</p>
          </div>

          <div className="tech-card">
            <div className="tech-icon kubernetes-icon">
              <img src={kubernetesLogo} alt="Kubernetes" />
            </div>
            <h3>Kubernetes</h3>
            <p>Open-source system for automating deployment, scaling, and management of apps</p>
          </div>
        </div>
        </div>
      </div>
