    ...
    const observer = new IntersectionObserver((entries) => {
      entries.forEach(entry => {
        if (entry.isIntersecting) {
          entry.target.classList.add('purpose-slide-in');
        }
      });
    }, observerOptions);
    ...
    <section id="purpose" className="purpose-main-section">
      <div className="container">
        <div className="section-container">
          <div className="purpose-header-section" ref={titleRef}>
            <h2>Our Purpose</h2>
            <div className="purpose-typewriter-wrapper">
              <p className="purpose-typewriter-content">
                {typedText}
          ...
          <div className="purpose-cards-grid">
            <div className="purpose-info-card purpose-vision-card" ref={visionRef}>
              <div className="purpose-card-glow-effect"></div>
              <div className="purpose-card-inner">
                <div className="purpose-card-icon purpose-vision-icon">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                    <circle cx="12" cy="12" r="3"></circle>
                  </svg>
                </div>
                <h3 className="purpose-card-heading">Our Vision</h3>
            ...
            <div className="purpose-info-card purpose-mission-card" ref={missionRef}>
              <div className="purpose-card-glow-effect"></div>
              <div className="purpose-card-inner">
                <div className="purpose-card-icon purpose-mission-icon">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    <circle cx="12" cy="12" r="3"></circle>
                ...
                <h3 className="purpose-card-heading">Our Mission</h3>
                <p className="purpose-card-description">
